...
import img from '../assests/images/contact-img.svg';
        ...
        <div className="contact bg-[linear-gradient(90deg,#b004b0,#38097a);] w-full">
          <div className="wrapper flex justify-center  py-16 gap-52 lg:py-12">
            <div className="imgbox lg:hidden">
              <img className="w-[550px] h-full" src={img} alt="Get-in-touch-form" />
            </div>
            <div className="content-box">
              ...
              <textarea
                ...
                placeholder="Message"
              ></textarea>
                  <button onClick={() => window.location = 'mailto:ivanov.vankis@gmail.com'} className="bg-white border-black border-[1] py-[16px] rounded-lg px-8 my-8 w-32 font-bold ">Send</button>
                  </form>
            </div>

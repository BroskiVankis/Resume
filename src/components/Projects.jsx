...
import img1 from "../assests/images/project-img1.png";
import img2 from "../assests/images/project-img2.png";
import img3 from "../assests/images/project-img3.png";
    ...
    return (
        <>
            <div className="projects bg-black text-white py-10">
                <h1 className="text-center text-4x1 font-bold py-6">Projects</h1>
                ...
                {durum === 2 ? (
                    <div id="text2"
                         className="tab-pane text-center text-white py-16 max-w-4x1 mx-auto lg:p-5">
                ...
                {durum === 3 ? (
                    <div
                        id="text1"
                        className="tap-pane text-center text-white py-5 lg:p-5">
